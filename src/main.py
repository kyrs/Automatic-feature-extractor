...
if __name__ == "__main__":
	obj = MainFeatureExt(foldBfProcess = "/mnt/hdd1/shubham/UNIL_ROUND_2_EXP/data/Videos_MIV_testAE", foldAftProcess = "/mnt/hdd1/shubham/UNIL_ROUND_2_EXP/data/processedOutputDir",
	 trimdetailCSV = "/mnt/hdd1/shubham/UNIL_ROUND_2_EXP/data/testFile.csv", copyFlag = True, trimFlag = True, wavExtFlag = True,  
